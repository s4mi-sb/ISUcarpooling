  ...
  const handleSubmit = async (e) =>{
    ...
    return (
      ...
      <div className='shadow shadow-red-700 p-4 bg-blue-200'>
        ...
        <p className='flex items-center'> Did not recieve a verification code? <Link to = "/resend"><span className='text-blue-500 cursor-pointer hover:underline ml-2'>resend</span></Link></p>
        ...
        <p className='uppercase font-bold'>The verifcation code might take a few minutes</p>
