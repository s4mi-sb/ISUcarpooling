    ...
    <section className='Homebg'>
      ...
      <div className='flex flex-col sm:flex-row lg:bg-slate-300'>
            <div className='flex flex-col flex-wrap px-10 pt-32 gap-10'>
              <h1 className='font-extralight p-3 bg-black sm:bg-white text-center text-white rounded-lg max-w-xl mx-auto sm:text-black mt-3 text-2xl sm:text-4xl font-mono'>Welcome!</h1>
